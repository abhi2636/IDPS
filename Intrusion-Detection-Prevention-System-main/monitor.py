...
def monitor_network_connections(interval=5, log_file='D:/PROJECTS/ns/Intrusion-Detection-Prevention-System-main/logs/network_connections_log.txt'):
...
def monitor_system_processes(interval=60, cpu_threshold=80, mem_threshold=80, log_file="D:/PROJECTS/ns/Intrusion-Detection-Prevention-System-main/logs/processes_log.txt"):
    while True:
